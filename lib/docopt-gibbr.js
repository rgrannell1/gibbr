...
//       -n dry-run
//       add gnu compatable version printing 'gibbr 0.2.0'
...
const doc = [
	...
	"    gibbr [--no-preserve-root|--preserve-root] [-r|-R|--recursive] [--size=<num>] [-v|--verbose] [<file>...]",
	"    gibbr (--version)",
	"    gibbr (-h | --help)",
	"",
	"DESCRIPTION:",
	...
	"    --size=<num>            [default: 12] the length of each new filename.",
